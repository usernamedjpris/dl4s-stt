...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", default="/home/mk/dl4s/WP6/mp3_scraper/data/checkpoints/checkpoint_best.pt", type=str, help="Path to fairseq checkpoint")
